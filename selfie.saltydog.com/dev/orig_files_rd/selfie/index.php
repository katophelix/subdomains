            ...
            <div class="page-content" style="padding-bottom:144px;">
              ...
              <div class="content-block">
                <div class="content-block-inner">
                  ...
                  <!-- <img class="webimg" src="http://98.101.223.10:8077/SnapshotJPEG?Resolution=640x480&Quality=Clarity&Count=1" alt="Please Stand By For Webcam Photo Upload" name="pic" id="pic" style="width:100%;">-->
                 <img class="webimg" src="http://98.101.223.10:8077/-wvhttp-01-/GetOneShot?image_size=640x480&REQUEST_ID=1177767237989" style="width:100%;" />
                 ...
                 <!-- <div style="width:100%;color:#fff !important;text-align:center;position:relative;top:50px;">
                  ...
                  <div id="mess">
					  ...
					  <div style="position:relative;top:-25px;padding:0px;width:100%;text-align:center;font-family:arial,sans-serif;font-size:16px;line-height:24px;color:#fff;">Hello from Hilton Head Island!</div>
