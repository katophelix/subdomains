...
$week = $date->format("W");
$year = $date->format("Y");
//print_r(getStartAndEndDate($week,$year));
$today = strtotime(date('Y-m-d 00:00:00'));
...
<option selected=selected value="">Select Dates</option>
<?php
$y=0;
while($y<=16){
if($y<1){
...
echo '<option value="'.date('m/d',$day).'-'.date('m/d',strtotime('+7 day',$day)).'">'.date('m/d',$day).'-'.date('m/d',strtotime('+7 day',$day)).'</option>';
$y++;
}
 ?>
</select>
...
@media(max-width: 900px){
  ...
  <div id="tabs">
    <div class="large-3 medium-4 small-4 columns" id="cruise" data-type="cruises" data-element="cruise" style="padding:0 !important;"><div style="height:40px;width:100%;display:block;background:#27ae60;line-height:40px;color:#fff;text-align:center;font-weight:bold;"><i class="fa fa-check"></i>Cruises</div></div>
  <div class="large-2 medium-4 small-4 columns" data-type="events" style="padding:0 !important;" data-element="Event"><div style="height:40px;width:100%;display:block;background:#9b59b6;line-height:40px;color:#fff;text-align:center;font-weight:bold;"><i class="fa fa-check"></i>Events</div></div>
  ...
  <div class="large-2 medium-6 small-6 columns" data-type="music" style="padding:0 !important;" data-element="Music"><div style="height:40px;width:100%;display:block;background:#2980b9;line-height:40px;color:#fff;text-align:center;font-weight:bold;"><i class="fa fa-check"></i>Music</div></div>
  <div class="large-3 medium-6 small-6 columns" data-type="wreck" style="padding:0 !important;" data-element="Wreck"><div style="height:40px;width:100%;display:block;background:#f39c12;line-height:40px;color:#fff;text-align:center;font-weight:bold;"><i class="fa fa-check"></i>The Wreck</div></div>
...
jQuery(document).ready(function($){
	...
	/*$('#tabs .columns').each(function(){
		...
		$(this).on('click touchstart tap',function(){
			$('i',this).toggleClass('fa-check');
		$('#test').html('');
		$('.loader').show();
...
<div class="large-5 columns" style="">
  <div style="width:100%;margin-bottom:20px;text-align:center;color:#fff;"><img src="../img/oyster2.jpg"></div>
  <div style="width:100%;margin-bottom:20px;text-align:center;color:#fff;"><img src="../img/ice.jpg"></div>
  <div style="width:100%;margin-bottom:20px;text-align:center;color:#fff;"><img src="../img/spring.jpg"></div>
</div>
