...
$kidsurl = "https://www.googleapis.com/calendar/v3/calendars/91ihjlbt85hgvoh5q68jt2tao0@group.calendar.google.com/events?key=AIzaSyD7GsjCq0vylLv6vv3A1WjkrFTOuidj-hU&singleEvents=true&orderBy=startTime&timeMin=".$dateTime."&maxResults=100&timeMax=".$dateTimeE;
$eventsurl = "https://www.googleapis.com/calendar/v3/calendars/k17oijbh2qli2amb79rs756q1o@group.calendar.google.com/events?key=AIzaSyD7GsjCq0vylLv6vv3A1WjkrFTOuidj-hU&singleEvents=true&orderBy=startTime&timeMin=".$dateTime."&maxResults=100&timeMax=".$dateTimeE;
$wreckurl="https://www.googleapis.com/calendar/v3/calendars/jakethesaltydog@gmail.com/events?key=AIzaSyD7GsjCq0vylLv6vv3A1WjkrFTOuidj-hU&singleEvents=true&orderBy=startTime&timeMin=".$dateTime."&maxResults=100&timeMax=".$dateTimeE;
$url="https://www.googleapis.com/calendar/v3/calendars/cnf5kjauuhebuqvhurr2smauq4@group.calendar.google.com/events?key=AIzaSyD7GsjCq0vylLv6vv3A1WjkrFTOuidj-hU&singleEvents=true&orderBy=startTime&timeMin=".$dateTime."&maxResults=100&timeMax=".$dateTimeE;
$ch = curl_init();
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_URL,$wreckurl);
$result=curl_exec($ch);
curl_close($ch);
...
echo '<div class="large-2 small-2 columns" style="background:#f39c12;color:#fff;height:100%;display:block;padding:0;margin:0;">';
...
echo '</div>';
echo '<div class="large-12 columns" style="padding:0;">';
echo '<div class="num" style="font-size:14px;line-height:30px;">Wreck</div>';
echo '</div>';
...
echo '<div class="title large-7 small-8 columns" style="font-size:18px;font-weight:300;padding:0;width:inherit">'.$item['location'].'<br><span style="font-size:12px;">more info<i class="fa fa-sign-out" style="margin-left:5px;"></i></span></div>';
